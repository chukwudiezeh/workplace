...
Route::prefix('workplace')->group(function(){
    ...
    Route::middleware('auth:sanctum')->group(function(){
        ...
        Route::prefix('{freelancer}')->group(function (){
            ...
            Route::post('upload_docs', [ProposalController::class, 'uploadProposalAttachment'])->middleware('freelancer');
            ...
            Route::prefix('jobInvites')->group(function(){
                Route::get('', [JobInviteController::class, 'seeInvites'])->middleware('freelancer');
                Route::prefix('{jobInvite}')->group(function(){
                    Route::get('', [JobInviteController::class, 'seeOneInvite'])->middleware('freelancer');
                    Route::patch('accept', [JobInviteController::class, 'acceptInvite'])->middleware('freelancer');//TODO notify client of acceptance
                    Route::patch('decline', [JobInviteController::class, 'declineInvite'])->middleware('freelancer');//TODO notify client of declination
                });
            });
